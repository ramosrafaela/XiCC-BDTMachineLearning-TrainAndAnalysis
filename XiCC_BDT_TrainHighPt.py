...
TRAIN = np.load('/hadrex1/storage2/rramos/stratrack/machinelearning/skywalker/data_train02/merge01/highpt/XiCC_DataTrain_Skywalker_npy.npy')
...
BDT = xgb.XGBRegressor(n_estimators=300, max_depth=8, learning_rate=0.1, objective='binary:logistic',random_state=42, max_delta_step=5.0)
...
plt.savefig('/hadrex1/storage2/rramos/stratrack/machinelearning/skywalker/data_train02/merge0'+str(merge)+'/highpt/res0'+str(num)+'/importance_feature_'+str(num)+'.pdf', format='pdf')
...
# save in JSON format
BDT.save_model('/hadrex1/storage2/rramos/stratrack/machinelearning/skywalker/data_train02/merge0'+str(merge)+'/highpt/res0'+str(num)+'/XiCC_BDT_Recipe_'+str(num)+'.json')
# save in text format
BDT.save_model('/hadrex1/storage2/rramos/stratrack/machinelearning/skywalker/data_train02/merge0'+str(merge)+'/highpt/res0'+str(num)+'/XiCC_BDT_Recipe_'+str(num)+'.txt')
